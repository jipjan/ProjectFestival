...
/**
 * Created by Lois Gussenhoven, 2118259 on 13-2-2017.
 */
public class CustomTabbedPaneUI extends BasicTabbedPaneUI{
    private Color selectColor, gradientColor;
    ...
    protected void installDefaults() {
        ...
        deSelectColor = new Color(171, 25, 54);
    ...
    protected void paintTabBackground(Graphics g, int tabPlacement, int tabIndex, int x, int y, int w, int h, boolean isSelected) {
        ...
        switch (tabPlacement) {
            case LEFT:
                ...
                gradientShadow = new GradientPaint(x, y,selectColor, x, y + h, gradientColor);
                break;
            case RIGHT:
            ...
            default:
                ...
                gradientShadow = new GradientPaint(0, 0, selectColor, 0, y + h / 2, gradientColor);
                break;
        }
        // ;
